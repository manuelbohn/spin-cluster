...
For comparison: likelihood from previous run (lesioned and pragmatic model only). See https://github.com/manuelbohn/spin/blob/master/stats/model_comparison.Rmd line 104.

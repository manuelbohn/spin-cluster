         ...
         var devMixtureModel = Infer({
            ...
            method: "enumerate"
                   ...
                   var modelPredictions = 
                    ...
                    (model_type == "bias") ? mixtureModel : devMixtureModel
                    ...
                    query.add(["likelihood",model_type], Math.exp(loglike))
...
```{r}
llh <- webppl(
  program_code = paste(model,llh, sep='\n'),
...
var priorProbs = (alignment_condition == "ff") ? "hey" : (alignment_condition == "ff") ? "hu" : "buh"

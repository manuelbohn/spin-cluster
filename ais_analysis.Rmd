...
```{r}
model <- '
// example call: time webppl integration_likelihood.wppl --require webppl-json --require webppl-csv
...
ais <- '
  ...
  var resultsOutFile = "likelihood/llh_integration.csv"
  var modelVariant = "integration"
...
```{r}
webppl(
  program_code = paste(model,ais, sep='\n'),
